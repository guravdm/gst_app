				...
				<div class="panel invoice-panel">
					...
					<%-- <%
						/* PreparedStatement us = con
									.prepareStatement("select count(*) as indexCount from invoicedetails where invoiceid = ?");
							us.setString(1, request.getParameter("viewInvId"));
							ResultSet ru = us.executeQuery();
							while(){
								
							} */
					%> --%>

					<!--  first invoice 8 rows end -->

					<!-- class="panel-body p20" -->
					<div class="panel-body pp01" id="invoice-item">
