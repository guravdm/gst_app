...
<%
	if (session.getAttribute("userId") != null) {
		...
		session.setAttribute("page", "client-list");
							...
							<div class="panel panel-visible" id="spy3">
								<div class="panel-heading">
									<div class="panel-title hidden-xs">
										<span class="glyphicon glyphicon-tasks"></span>Client List <span
											style="float: right; margin-right: 20px;"><a
											href="client-new.jsp">New Client</a></span>
									</div>
								...
								<div class="panel-body pn">
									<table style="font-size: 13px"
										...
										<tbody>
											...
											%>
											<tr>
												<td><span class="label label-rounded label-danger"><%=rs.getString("client_id")%></span></td>
												<td><%=rs.getString("company_name")%></td>
												<td><%=rs.getString("f_name") + "  "
							+ rs.getString("l_name")%></td>
												<%-- <td><%=rs.getString("email")%></td> --%>
												<td><%=rs.getString("mob_no")%></td>
												<td><span class="label label-rounded label-system"><%=rs.getString("gst_no")%></span></td>
												<%-- <td><span style="text-align: justify;"><%=rs.getString("address")%></span></td> --%>
												<td><%=rs.getString("updated_time")%></td>
												<td><a target="_BLANK"
													href="view-cust-mtrl-list.jsp?custcode=<%=rs.getString("id")%>">
														list</a></td>
												<td><a class="fa fa-edit fa-lg" title="Edit"
													href="client-edit.jsp?uId=<%=rs.getString("id")%>"><span></span></a>
													<span style="margin-left: 18px;"></span><a
													class="fa fa-trash-o fa-lg" title="Delete"
													onclick="return confirm('Are you sure!?')"
													href="./DeleteClient?deleteId=<%=rs.getString("id")%>"><span></span></a>
													<span style="margin-left: 18px;"></span> <a
													class="fa fa-plus fa-lg" title="Add PO"
													href="po-new.jsp?clientId=<%=rs.getString("id")%>"><span></span></a></td>
											</tr>
											<%
												}
											%>
