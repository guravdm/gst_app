...
<%
	if (session.getAttribute("userId") != null) {
		...
		session.setAttribute("page", "client-edit");
...
<body class="dashboard-page sb-l-o sb-r-c">
	...
	<div id="main">
		...
		<div class="topbar-right hidden-xs hidden-sm">
			...
			</a> <a href="client-edit.jsp?uId=<%=request.getParameter("uId")%>"
				class="btn btn-default btn-sm light fw600 ml10"> <span
		...
		<div class="tray tray-center">
			<div class="admin-form theme-primary mw1000 center-block"
				...
				<div class="panel heading-border">
					<form method="post" action="./UpdateClientCntrl" id="admin-form"
						autocomplete="off">
						<div class="panel-body bg-light">
							<div class="section-divider mt20 mb40">
								<span>Modify Client Information</span>
							</div>
							...
							<div class="section">
								<label for="companyName" class="field prepend-icon"> <input
									...
									class="gui-input" placeholder="Company Name"
									value="<%=r.getString("company_name")%>"> <label
							...
							<div class="section row" id="spy1">
								<div class="col-md-6">
									<label for="firstname" class="field prepend-icon"> <input
										value="<%=r.getString("f_name")%>" type="text"
							...
							<div class="section">
								<label for="useremail" class="field prepend-icon"> <input
									value="<%=r.getString("email")%>" type="email" name="useremail"
									id="useremail" class="gui-input" placeholder="Email address">
							...
							<div class="section row">
								<div class="col-md-6">
									<label for="gstNo" class="field prepend-icon"> <input
										...
										<label for="gstNo" class="field-icon"> <i
											class="fa fa-male"></i>
									</label>
									</label>
								</div>
							...
							<div class="section" id="spy3">
								<label for="comment" class="field prepend-icon"> <textarea
										...
										placeholder="Address"><%=r.getString("address")%></textarea> <label
