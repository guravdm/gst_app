...
<body class="dashboard-page sb-l-o sb-r-c">
	...
	<div id="main">
		...
		</header> <section id="content" class="animated fadeIn"> <%-- <table>
			<tr>
				<td><%=invoiceData.getId()%></td>
				<br>
				<td><%=invoiceData.getChallanDate()%></td>
				<br>
				<td><%=invoiceData.getCustCode()%></td>
				<br>
				<td><%=invoiceData.getPoNo()%></td>
				<br>
			</tr>
		</table> --%>
