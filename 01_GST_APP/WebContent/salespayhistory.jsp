					...
					<div class="panel panel-visible" id="spy3">
						<div class="panel-heading">
							<div class="panel-title hidden-xs">
								...
								List <span style="float: right; margin-right: 20px;">
							</div>
									...
									<%
										int cnt = 0;
											...
											PreparedStatement ps = con
													.prepareStatement("select * from SALES_PAY_HISTORY");
											ResultSet rs = ps.executeQuery();
											while (rs.next()) {
												Date date = rs.getDate("pay_made_date");
												cnt++;
												SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy-MM-dd");
												SimpleDateFormat sdf2 = new SimpleDateFormat("dd-MMM-yyyy");
												String payMadeDate = sdf2.format(date);
									%>
									<tr>
										<td><span><%=cnt%></span></td>
										...
										%>
										<td><%=rs.getString("balance_amnt")%></td>
										<td><%=rs.getString("PaymentAmount")%></td>

										<%-- <%
											Integer bal = Integer
															.parseInt(rs.getString("balance_amnt"));
													Integer pay = Integer.parseInt(rs
															.getString("PaymentAmount"));
													Integer outStanding = bal - pay;
										%> --%>

										<td><%=rs.getString("outStanding")%></td>
										<td><%=payMadeDate%></td>
									</tr>
									<%
										}
